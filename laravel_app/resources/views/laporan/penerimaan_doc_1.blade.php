<?php 
    ...
    header("Content-Disposition: attachment; filename=Laporan-Penrimaan-".$bulannya[$from]."-".$tahun.".doc");
                                        ...
                                        <?php 
                                                    ...
                                                    ?>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ @$d->keterangan }} <?php echo @$d->barang->unit->kode ?>,<?php echo @$d->barang->unit->jenis_unit->kode ?> </td>
                                                        </tr>
