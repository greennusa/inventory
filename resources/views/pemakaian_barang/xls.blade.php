<?php 
	...
	header("Content-Disposition: attachment; filename=pemakaian-".$r->tanggal."- ".$date.".xls");
                ...
                <div class="panel-body" style="border: none;">
					...
					<table style="width: 100%;word-break: break-all;text-align: center;" border="1">
					    ...
					    <tbody>
					        ...
					        <?php $ttl_jumlah = 0;$ttl_harga =0; foreach ($r->detail_semua as $d): $total = @$d->jumlah * @$d->detail_bbk->harga+@$d->camp_lama->harga; ?>
					            @if(@$d->gabungan == '' || @$d->gabungan == null)
						            <tr align="center">
						               <?php $db = \App\DetailPemesananBarang::where('gabungan','like','%'.@$d->gabungan_id.'%')->get();?>
						                ...
						                <td>
						                    Rp.<?php echo number_format(@$d->detail_bbk->harga+@$d->camp_lama->harga) ?>
						                </td>
						                <td>
