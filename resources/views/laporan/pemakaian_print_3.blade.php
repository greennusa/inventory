                   ...
                   <table class="table table-bordered table-hover">
                     ...
                     <tr>
                       ...
                       use App\User;
                        ...
                        <td>{{number_format($total_col[0])}}</td>

                        <td>{{number_format($total_col[1])}}</td>

                        <td>{{number_format($total_col[2])}}</td>

                        <td>{{number_format($total_col[3])}}</td>

                        <td>{{number_format($total_col[4])}}</td>

                        <td>{{number_format($total_col[5])}}</td>

                        <td>{{number_format($total_col[6])}}</td>

                        <td>{{number_format($total_col[7])}}</td>

                        <td>{{number_format($total_col[8])}}</td>
                     ...
                     <tr>
                       ...
                       <?php 
                        ...
                        <td>{{number_format($total_col[9])}}</td>

                        <td>{{number_format($total_col[10])}}</td>

                        <td>{{number_format($total_col[11])}}</td>
