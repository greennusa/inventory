    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Laporan Penerimaan Barang<br><br> <a class="btn btn-default" href="{{ url('report') }}">Kembali</a></div>



                <div class="panel-body">

                    <form class="form-inline" action="<?php echo url("report/penerimaan/print_laporan") ?>" target="_blank">
