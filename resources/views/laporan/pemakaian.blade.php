...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Laporan Pemakaian Barang <br><br> <a class="btn btn-default" href="{{ url('report') }}">Kembali</a></div>

                <div class="panel-body">
                    <form class="form-inline" action="<?php echo url("report/pemakaian/print_laporan") ?>" target="_blank">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Rekapitulasi Pemakaian Barang</div>

                <div class="panel-body">
                    <form class="form-inline" action="<?php echo url("report/pemakaian/print_rekapitulasi") ?>" target="_blank">
                        <select class="selectpicker" name="tahun" data-live-search="true" required>
                            <?php 
                        ...
                        <br>
                        <select class="selectpicker" name="diketahui" id="diketahui" data-live-search="true" required>
                            <option value="">Diketahuhi Oleh</option>
                            <?php foreach ($user as $u): ?>
                                <option value="<?php echo $u->id ?>" ><?php echo $u->nama ?></option>
                            <?php endforeach ?>
                        </select>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Grafik Pemakaian Barang</div>

                <div class="panel-body">
                    <form class="form-inline" action="<?php echo url("report/pemakaian/print_grafik") ?>" target="_blank">
                        <select class="selectpicker" name="tahun" data-live-search="true" required>
                            <?php 
                                for ($i=2000; $i < (int)date('Y')+1; $i++) { 
                                    if((int)date('Y') == $i){
