                ...
                <div class="panel-body" style="border: none;margin:0;padding: 0;">
					...
					<table style="word-break: break-all;width: 100%;font-size: 10px;text-align: center;" border="1">
					    ...
					    <tbody>
					        ...
					        <?php $no = 1;foreach ($r->detail_semua as $d): $total = @$d->jumlah * @$d->detail_bbk->harga; ?>
					            ...
					            <tr align="center">
					                ...
					                <td>
					                	<?php if(@$d->detail_bbk->detail_bbm->detail_pemesanan->kode_barang != null || @$d->detail_bbk->detail_bbm->detail_pemesanan->kode_barang != ''){ echo @$d->detail_bbk->detail_bbm->detail_pemesanan->kode_barang; }else if($d->detail_bbk == null){echo $d->camp_lama->kode_barang;} else { echo @$d->barang->kode; }?>
                                                    <?php if($d->detail_bbk != null){foreach($db as $dd): ?>
                                                     / <?php echo $dd->barang->kode ?>
                                                    <?php endforeach;} ?>
					                </td>
					                <td>
					                	<?php if(@$d->detail_bbk->detail_bbm->detail_pemesanan->nama_barang != null || @$d->detail_bbk->detail_bbm->detail_pemesanan->nama_barang != ''){ echo @$d->detail_bbk->detail_bbm->detail_pemesanan->nama_barang; }else if($d->detail_bbk == null){echo $d->camp_lama->nama_barang;} else { echo @$d->barang->nama; }?> 
                                                    <?php if($d->detail_bbk != null){foreach($db as $dd): ?>
